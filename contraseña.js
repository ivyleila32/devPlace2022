...
const userPassword= readline.question('Ingrese una contraseña : ', {hideEchoBack: true});
for (let i = 1; i <= maxAttemps; i++) {
    const intento = readline.question(`Vuelva a ingresar su contraseña. (Intento ${i})`, {hideEchoBack: true});
